...
DeleteItemFromWishListUseCase injectDeleteItemFromWishListUseCase() {
  return DeleteItemFromWishListUseCase(
      repositoryContract: injectWishListRepositoryContract());
}

DeleteItemFromCartUseCase injectDeleteItemInCartUseCase() {
  return DeleteItemFromCartUseCase(
